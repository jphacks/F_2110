...
* 絶対に業務に支障をきたさない
* フルオンラインでの開発
* 7daysでチームビルディング、コンセプト策定からプロトタイプでのデモまで走り切る
...
#### バックエンド
* 学習用画像の枚数増加
* epoch数/batchsize/iterationの値の吟味
* SVスペックの向上による出力速度改善（現在50枚epoch200で15分）
* スプリクトの可読性、変更容易性を上げる
...
### Demo(動作イメージ)
* 最後に出力している画像は学習用データ50枚、epoch200で作成
![Animated GIF-downsized(1)](dev-face-demo.gif)
